...
export class Backend implements backendInterface {
    ...
    async createPackage(arg0: Package): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getAllActivePackages(): Promise<Array<Package>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllActivePackages();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPackageById(arg0: bigint): Promise<Package> {
        if (this.processError) {
            try {
    ...
    async reorderPackages(arg0: Array<bigint>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.reorderPackages(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async togglePackageActiveStatus(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.togglePackageActiveStatus(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
