...
function StickyCallBar() {
  return (
    ...
    >
      <div className="bg-white border-t border-gray-200 shadow-[0_-4px_16px_rgba(0,0,0,0.12)] px-3 py-2.5 flex items-center gap-2">
        {/* Call button */}
        <a
          href="tel:+919160393773"
          data-ocid="offer.primary_button"
          className="flex-1 flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 active:bg-green-700 text-white font-extrabold text-base py-3 rounded-xl transition-colors shadow-md"
        >
        ...
        <a
          ...
          className="flex items-center justify-center w-12 h-12 bg-[#25D366] hover:bg-[#1ebe5d] active:bg-[#17a84f] rounded-xl transition-colors shadow-md flex-shrink-0"
        >
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
...
export function LandingOfferPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans pb-20 sm:pb-0">
      {/* ── Top Bar ── */}
